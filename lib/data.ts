...
export const profile = {
  ...
  name: "syake-ichiro",
  bio: `某通信会社でエンジニアとして4年間勤務。アカウント管理・アラート監視・マスタ管理など複数システムと連携し、社内のサーバー作業を管理するワークフローシステム（Django / Angular）の開発・保守を担当してきました。リリース作業の自動化による工数90%削減や、SSOリダイレクトを活用したダイレクトリンク機能の実現など、業務改善を主導した経験もあります。現在はNext.js・Dockerなどモダンなスタックを独学しながら、副業エンジニアとして自分のプロダクトを育てています。丁寧に、一つずつ。`,
  facts: [
    { num: "4+", label: "年の実務経験" },
...
export const skills: SkillCategory[] = [
  ...
  },
  {
    ...
    title: "Backend",
    skills: [
      { name: "Python", level: "4y" },
      { name: "Django", level: "4y" },
      { name: "uWSGI", level: "4y" },
